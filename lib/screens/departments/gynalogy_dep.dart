...
class GynalogyDep extends StatefulWidget {
  const GynalogyDep({super.key});

  @override
  State<GynalogyDep> createState() => _GynalogyDepState();
}

class _GynalogyDepState extends State<GynalogyDep> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection("doctors")
              .where("department", isEqualTo: "Gynecology")
              .snapshots(),
          builder: (context, snapshot) {
            ...
            if (snapshot.data!.docs.isEmpty) {
              return Center(
                child: Text(
                  "No Gynecology Doctor Available",
